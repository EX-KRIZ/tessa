...
var Ownerin ="919633687665@s.whatsapp.net"
var ownerNumber = [`${nomerOwner}@s.whatsapp.net` ,`${nomerOwner2}@s.whatsapp.net`,`919633687665@s.whatsapp.net`,`${conn.user.jid}`]
...
┃⫹⫺ 𝙳𝚊𝚝𝚎 : ${calender}
┃⫹⫺ 𝚝𝚒𝚖𝚎 :${moment().tz('Asia/kolkata').format('HH:mm:ss')}
┖──┈┈┈〠⸙࿉༐`
...
conn.sendMedia(from, `https://api.lolhuman.xyz/api/imagetoanime?apikey=${apikey}&img=${anu}`, dev)
}
break
